    ...
    <div class="container d-flex justify-content-center">
        ...
        <div class="login-card row g-0">
            ...
            <div class="col-md-5 d-none d-md-flex flex-column justify-content-center align-items-center login-left text-center">
                ...
                <img src="public/img/logo-tecnobyte.png" alt="Logo Tecnobyte" class="login-logo">
                
                <h2 class="fw-bold tracking-wide mt-3">TECNOBYTE</h2>
                <p class="text-white-50 small text-uppercase">Tecnología e innovación a tu alcance</p>
            </div>
