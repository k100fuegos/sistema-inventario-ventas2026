...
<head>
    <meta charset="UTF-8">
    <title>Editar Producto - Tecnobyte</title>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="codigo" value="LÓGICA PHP" required>
                                </div>
                            ...
                            <div class="row align-items-center mb-3">
                                <div class="col-md-2 text-center">
                                    <img src="../../../public/img/placeholder.png" alt="Actual" class="img-thumbnail" style="width: 80px; height: 80px; object-fit: cover;">
                                </div>
                                <div class="col-md-10">
                                    <label class="form-label fw-bold">Actualizar Imagen (Opcional)</label>
                                    <input type="file" class="form-control" name="imagen" accept="image/*">
                                    <div class="form-text">Si no selecciona ningún archivo, se mantendrá la imagen actual.</div>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-bold">id_categoria</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="precio" value="LÓGICA PHP" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label fw-bold">stock</label>
                                    <input type="number" class="form-control" name="stock" value="LÓGICA PHP" required>
                                </div>
                            </div>
