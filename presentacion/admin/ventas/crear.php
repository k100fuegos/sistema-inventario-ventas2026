...
<body>
    ...
    <script>
        ...
        function mostrarDetallesProducto() {
            ...
            const imagenSrc = (p.imagen_producto && p.imagen_producto !== 'sin-imagen.png') 
                ? `../../../public/img/productos/${p.imagen_producto}` 
                : `../../../public/img/sin-imagen.png`;

            contenedor.innerHTML = `
                <div class="row fs-6 w-100 mt-2">
                    <div class="col-md-4 text-center mb-3">
                        <img src="${imagenSrc}" onerror="this.onerror=null; this.src='../../../public/img/sin-imagen.png';" alt="Imagen del Producto" class="img-fluid rounded shadow-sm border" style="max-height: 140px; object-fit: contain; width: 100%; background: #fff; padding: 5px;">
                    </div>
